...
Route::get('/browse/{Profile:foto_profile}', [FrontController::class, 'Profile'])->name('front.index');  
...
Route::post('/booking/payment/store', [BookingController::class, 'paymentStore'])->name('front.payment_store');  
